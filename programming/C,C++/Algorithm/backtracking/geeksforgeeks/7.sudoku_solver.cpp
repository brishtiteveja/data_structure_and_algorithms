...
// Takes a partially filled-in grid and attempts to assign values to all unassigned locations in sucha a way to meet the requirements for Sudoku solution (non-duplication across rows, columns, and boxes) 
...
/* Returns a boolean which indicats whether an assigned entry in the specified row matches the given number */
